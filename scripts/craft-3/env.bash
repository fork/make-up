...
E_STAGING_DOCKER_COMPOSE_FILE=COMPOSE_FILE
E_STAGING_DOCKER_COMPOSE_SERVICE=SERVICE
EOF
}
...
E_PRODUCTION_DOCKER_COMPOSE_FILE=COMPOSE_FILE
E_PRODUCTION_DOCKER_COMPOSE_SERVICE=SERVICE
EOF
}
